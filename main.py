...
if __name__ == '__main__':
    ...
    main_window.form.filterButton.clicked.connect(filter_window.update_filter_data)
    ...
    main_window.form.rasp.triggered.connect(main_window.print_filter(filter_window))
